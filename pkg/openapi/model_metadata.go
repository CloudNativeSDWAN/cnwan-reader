...
// Metadata The metadata observed. The list only includes the ones that have been included in the command line arguments of the CNWAN Reader.
type Metadata struct {
	// The name of the key in the metadata, if present in the object. Included only if required as argument in the CNWAN Reader.
	Key string `json:"key"`
